              ...
              <div>
                ...
                {!selectedFile ? (
                  ...
                  <div className="mt-2 relative">
                    <div className="relative w-full aspect-square rounded-lg overflow-hidden bg-zinc-800 border-2 border-pink-500/30">
                      {fileType === 'image' ? (
                        <Image
                          src={previewUrl}
                          alt="Preview"
                  ...
                  <Card className="bg-black border-zinc-800 overflow-hidden">
                    <CardContent className="p-0">
                      ...
                      <div className="p-4 space-y-2">
                        ...
                        {hashtags.trim() && (
                          <p className="text-xs text-pink-400 break-words">
                            {hashtags
                              .split(/[\s,]+/)
                              .map((tag) => tag.trim())
                              .filter(Boolean)
