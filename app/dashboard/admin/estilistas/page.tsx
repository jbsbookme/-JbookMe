  ...
  const handleAddBarber = async () => {
    ...
    if (useExistingUser) {
      ...
      if (!newBarberForm.name || !newBarberForm.email) {
        toast.error('Please complete the name and email');
        return;
      }
    ...
    try {
      ...
      if (response.ok) {
        ...
        const error = await response.json();
        toast.error(error.error || 'Error adding stylist');
      }
    } catch (error) {
    ...
    try {
      const response = await fetch(`/api/barbers/${selectedBarber.id}`, {
        ...
        body: JSON.stringify({
          ...
          gender: editBarberForm.gender || 'FEMALE',
      ...
      if (response.ok) {
        ...
        const error = await response.json();
        toast.error(error.error || 'Error updating stylist');
      }
    } catch (error) {
      console.error('Error updating barber:', error);
      toast.error('Error updating stylist');
    } finally {
      setSubmitting(false);
    }
  };
  ...
  const handleDeleteBarber = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const error = await response.json();
        toast.error(error.error || 'Error deleting stylist');
      }
    } catch (error) {
      console.error('Error deleting barber:', error);
      toast.error('Error deleting stylist');
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-white mb-2">
              <span className="text-[#00f0ff]">Stylists</span> Management (Women)
            </h1>
        ...
        {barbers.length === 0 ? (
          <Card className="bg-[#1a1a1a] border-gray-800">
            <CardContent className="py-12 text-center">
              ...
              <p className="text-gray-400 mb-4">No stylists registered</p>
              <Button
                onClick={() => setIsAddDialogOpen(true)}
                variant="outline"
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent className="bg-[#1a1a1a] border-gray-800 text-white max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-[#00f0ff]">Add New Stylist</DialogTitle>
            <DialogDescription className="text-gray-400">
              Complete the new stylist&apos;s information
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
              ...
              <>
                ...
                <div>
                  ...
                  <Input
                    ...
                    className="bg-[#0a0a0a] border-gray-700 text-white"
                  />
                  <p className="text-xs text-gray-500 mt-1">Password used to access the system</p>
                </div>
              </>
            )}
            
            <div>
              <Label htmlFor="contactEmail" className="text-gray-300">Stylist Personal Email</Label>
              <Input
                id="contactEmail"
                type="email"
            ...
            {/* REMOVED: Gender selector - This page only manages FEMALE stylists */}
            ...
            <div>
              ...
              <Input
                ...
                placeholder="E.g: Classic cuts, Styling, Color"
                className="bg-[#0a0a0a] border-gray-700 text-white"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Describe the stylist's experience and style..."
                className="bg-[#0a0a0a] border-gray-700 text-white"
                rows={3}
              />
            </div>
            ...
            <div className="border-t border-gray-700 pt-4 space-y-3">
              ...
              <p className="text-xs text-gray-500 mb-3">Configure the payment methods this stylist accepts</p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4 space-y-3">
                ...
                <div>
                  <Label htmlFor="zelleEmail" className="text-gray-400 text-sm">Zelle Email</Label>
                  <Input
                    id="zelleEmail"
                    type="email"
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="bg-[#1a1a1a] border-gray-800 text-white max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-[#00f0ff]">Edit Stylist</DialogTitle>
            <DialogDescription className="text-gray-400">
              Update information for {selectedBarber?.user?.name}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div>
            ...
            <div>
              <Label htmlFor="edit-contactEmail" className="text-gray-300">Stylist Personal Email</Label>
              <Input
            ...
            {/* REMOVED: Gender selector - This page only manages FEMALE stylists */}
            <input type="hidden" name="edit-gender" value="FEMALE" />
            ...
            <div className="border-t border-gray-700 pt-4 space-y-3">
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4 space-y-3">
                ...
                <div>
                  <Label htmlFor="edit-zelleEmail" className="text-gray-400 text-sm">Zelle Email</Label>
                  <Input
                    id="edit-zelleEmail"
                    type="email"
            ...
            <div>
              ...
              <div className="mt-2">
                <Label htmlFor="edit-profileImage-url" className="text-gray-500 text-xs">Or enter a URL (optional)</Label>
                <Input
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                className="w-4 h-4 text-[#00f0ff] bg-[#0a0a0a] border-gray-700 rounded focus:ring-[#00f0ff]"
              />
              <Label htmlFor="edit-isActive" className="text-gray-300">Active stylist</Label>
            </div>
          </div>
          <DialogFooter>
            <Button
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent className="bg-[#1a1a1a] border-gray-800 text-white">
          <AlertDialogHeader>
            <AlertDialogTitle className="text-red-500">⚠️ Delete stylist permanently?</AlertDialogTitle>
            <AlertDialogDescription className="text-gray-400">
              ...
              <ul className="list-disc list-inside mt-2 text-gray-300 space-y-1">
                <li>Stylist profile</li>
                <li>Schedules and availability</li>
                <li>Photo/video gallery</li>
                <li>Payment history</li>
              </ul>
              <br/>
              <span className="text-yellow-400">Note:</span> If the stylist has pending or confirmed appointments, they cannot be deleted until those appointments are canceled.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
